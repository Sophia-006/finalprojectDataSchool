...
knitr::kable(head(my_database, n = 5), format = "html", caption = "Protein Database") %>% 
  ...
  footnote(general= "5 examples of proteins found in the database. The column sequence, indicates the aminoacids (letter code) that make up each protein.",
          footnote_as_chunk = T)
```

What we will do now is to look for the aminoacids **Q** and **P**.
