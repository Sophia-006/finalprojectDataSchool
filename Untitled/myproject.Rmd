...
## Preliminary results
I will analyse the amino acids composition of the proteins of my database. Since gluten proteins have a high composition of the amino acids Glutamine (Q) and Proline (P). I will search for all proteins that have over 20% Glutamine and 10% Proline.
...
**Plotting**
```{r standard-plot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="Glutamine and Proline composition in Ryegrass"}
gluten_q20 <- read.csv('Data/proteins_Q20.csv')
ggplot(my_database_comp1 )+
  ...
  geom_point(data=proteins_Q20, mapping = aes(x=P100, y=Q100), colour= 'maroon3')
  
ggplot(proteins_Q20,aes(x=Q100))+
  geom_histogram(binwidth=1, fill="#69b3a2", color="#e9ecef", alpha=0.9)+
  labs(title='Ryegrass proteins with >20% Glutamine',
         x='Q%')+
  theme(title = element_text("bold"))

ggplot(gluten_q20,aes(x=Q100, y=P100, colour=Name))+
  geom_point()


write.csv(proteins_Q20, 'Data/proteins_Q20.csv')
```
